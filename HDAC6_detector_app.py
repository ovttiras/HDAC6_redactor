...
models_option = st.sidebar.selectbox('Select QSAR models for prediction', ('GBM_ECFP4', 'RF_Padel'))
...
#                 m, fpFunction, lambda x: getProba(x, load_model_GBM.predict_proba), colorMap=cm.PiYG_r)
